...
Feature  | Chrome | Firefox | Safari | Edage | IE11 | IE10
-------- | ------ | ------- | ------ | ----- | ---- | ---- 
基本上传  | `支持`  |  `支持`  | `支持`  | `支持` | `支持` | `支持`
复制系统文件上传 | `支持` | `不支持` | `有问题` | `不支持` | `不支持` | `不支持`
复制网页图像上传 | `支持` | `不支持` | `不支持` | `支持` | `不支持` | `不支持` 
截图上传 | `支持` | `不支持` | `不支持` | `支持` | `部分支持` | `不支持` 
拖拽上传  | `目录和文件` | `文件` | `文件` | `不支持` | `文件` | `文件` 
秒传     | `支持` | `支持` | `支持` | `支持` | `支持` | `支持`
分片上传  | `支持` | `支持` | `支持` | `支持` | `支持` | `支持`
