...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcCollectorDnd = __webpack_require__(4);
	
	var _srcCollectorDnd2 = _interopRequireDefault(_srcCollectorDnd);
	
	var _srcCollectorPaste = __webpack_require__(5);
	
	var _srcCollectorPaste2 = _interopRequireDefault(_srcCollectorPaste);
	
	var _srcCollectorPicker = __webpack_require__(6);
	
	var _srcCollectorPicker2 = _interopRequireDefault(_srcCollectorPicker);
	
	exports['default'] = _srcContext2['default'];
	exports.Events = _srcEvents2['default'];
	exports.Status = _srcStatus2['default'];
	exports.DndCollector = _srcCollectorDnd2['default'];
	exports.PasteCollector = _srcCollectorPaste2['default'];
	exports.PickerCollector = _srcCollectorPicker2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Emitter2 = __webpack_require__(8);
	...
	var Context = (function (_Emitter) {
	    ...
	    _createClass(Context, [{
	        ...
	        value: function add(file) {
	            ...
	            file.on(_Events2['default'].FILE_UPLOAD_PROGRESS, function () {
	                _this2.emit(_Events2['default'].QUEUE_UPLOAD_PROGRESS);
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = (function () {
	    ...
	    _createClass(Emitter, [{
	        ...
	        key: 'revoke',
	        value: function revoke(event, data) {
	            event = event.toLowerCase();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Runtime2 = __webpack_require__(14);
	...
	var File = (function (_Emitter) {
	    ...
	    _createClass(File, [{
	        ...
	        value: function complete(response) {
	            ...
	            var complete = this.context.revoke(_Events2['default'].FILE_UPLOAD_COMPLETING, response);
